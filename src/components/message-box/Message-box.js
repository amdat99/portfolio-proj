...
function MessageBox({
  ...
  return (
    <div>
      {messageData ? (
        <div>
          <ul id={userid === currentUser.profileId.toString()? 'message-box-containeruser': "message-box-container"} >
          ...
          {images ? (
            image ? (
              <LazyLoadImage
              id={userid !== currentUser.profileId.toString()?"message-box-image":'message-box-image-s'}
                onError={imageToggle}
                src={image}
                alt="upload"
