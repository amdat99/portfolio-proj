...
function ShopMenu({imageUrl, title, linkUrl,match,history,fetchCategoryPending}) {
    ...
    return (
     ...
     <div className='shopmenu-content'  onClick={() => history.push(`category/${linkUrl}`) } >

       <h1  className='shopmenu-title' 
       >{title.toUpperCase()}  </h1>
       <span className='shopmenu-subtitle' onClick={() => history.push(`category/${linkUrl}`) }>SHOP NOW</span>
